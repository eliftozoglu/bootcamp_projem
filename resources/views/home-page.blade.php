...
<head>
    ...
    <script src="{{asset('https://unpkg.com/scrollreveal@4.0.0/dist/scrollreveal.min.js')}}"></script>
</head>
        ...
        <section class="hero">
            <div class="container">
                <div class="hero-inner">
                    <div class="hero-copy">
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">Layouts</h1>
                        <p class="hero-paragraph is-revealing">Layouts is the easiest way to create impressive presentations and reports. Create presentations and impress those around you using our templates. Sign up now! </p>

                        <p class="hero-cta is-revealing"><a class="button button-primary button-shadow" onclick="location.href='/login'" href="#">LOGIN</a></p>
                        <p class="hero-cta is-revealing"><a class="button button-primary button-shadow" onclick="location.href='/register'" href="#">REGISTER</a></p>
