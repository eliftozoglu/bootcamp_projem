    ...
    <div class="cart-content d-flex">
        ...
        <div class="cart-amount-summary">
            ...
            <div class="checkout-btn mt-100">
                <a href="{{asset('checkout.html')}}" class="btn essence-btn">check out</a>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                ...
                                <div class="product-img">
                                    ...
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="{{asset('img/product-img/product-6.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                ...
                                <div class="product-img">
                                    ...
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="{{asset('img/product-img/product-7.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="{{asset('img/product-img/product-7.jpg')}}" alt="">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="{{asset('img/product-img/product-8.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="{{asset('img/product-img/product-8.jpg')}}" alt="">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="{{asset('img/product-img/product-9.jpg')}}" alt="">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-product-wrapper">
                                <!-- Product Image -->
                                <div class="product-img">
                                    <img src="{{asset('img/product-img/product-9.jpg')}}" alt="">
                                    <!-- Hover Thumb -->
                                    <img class="hover-img" src="{{asset('img/product-img/product-1.jpg')}}" alt="">
