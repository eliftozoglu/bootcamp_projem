                                    ...
                                    <div class="nofity-list">
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{asset('asset/images/author/author-img1.jpg')}}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{asset('asset/images/author/author-img2.jpg')}}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{asset('asset/images/author/author-img3.jpg')}}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{asset('asset/images/author/author-img4.jpg')}}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                        ...
                        <nav>
                            <ul id="nav_menu">
                                <li>
                                    ...
                                    <ul class="submenu">
                                        <li><a href="{{asset('index.html')}}">ICO dashboard</a></li>
                                        <li><a href="{{asset('index2.html')}}">Ecommerce dashboard</a></li>
                                        <li><a href="{{asset('index3.html')}}">SEO dashboard</a></li>
                                    </ul>
                                </li>
                                <li class="active">
                                ...
                                <li class="mega-menu">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li><a href="{{asset('login2.html')}}">Login 2</a></li>
                                        <li><a href="{{asset('login3.html')}}">Login 3</a></li>
                                        <li><a href="{{asset('register.html')}}">Register</a></li>
                                        <li><a href="{{asset('register2.html')}}">Register 2</a></li>
                                        <li><a href="{{asset('register3.html')}}">Register 3</a></li>
                                        <li><a href="{{asset('register4.html')}}">Register 4</a></li>
                                        <li><a href="{{asset('screenlock.html')}}">Lock Screen</a></li>
                                        <li><a href="{{asset('screenlock2.html')}}">Lock Screen 2</a></li>
                                        <li><a href="{{asset('reset-pass.html')}}">reset password</a></li>
                                        <li><a href="{{asset('pricing.html')}}">Pricing</a></li>
                                        <li><a href="{{asset('404.html')}}">Error 404</a></li>
                                        <li><a href="{{asset('500.html')}}">Error 500</a></li>
...
<script src="{{asset('https://www.amcharts.com/lib/3/ammap.js')}}"></script>
<script src="{{asset('https://www.amcharts.com/lib/3/maps/js/worldLow.js')}}"></script>
...
<script src="{{asset('asset/js/line-chart.js')}}"></script>
<!-- all pie chart -->
<script src="{{asset('asset/js/pie-chart.js')}}"></script>
<!-- all bar chart -->
<script src="{{asset('asset/js/bar-chart.js')}}"></script>
<!-- all map chart -->
